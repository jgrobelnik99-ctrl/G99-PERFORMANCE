import { initializeApp } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";
    ...
    window.getColorForOvr = function(ovr) {
        ...
        if (ovr>=80) return "#9fe8ff"; if (ovr>=70) return "#1fd98a"; if (ovr>=60) return "#f1c40f";
    ...
    window.dobiFoilTier = function(o) {
        ...
        if(o >= 60) return 'foil-t2';  // Gold / Emerald
    ...
    window.getRankClassAndName = function(o, lng) {
        ...
        if (o>=70) return {c: "rank-emerald", n: lng.rNames[4]};
    ...
    window.pokaziMetodologijo = function() {
        ...
        let rangi = [
            ...
            [70, 79, 'EMERALD'], [80, 88, 'DIAMOND'], [89, 93, 'PRIME'],
    ...
    // Odpre/zapre "Več" meni v mobilni spodnji navigaciji (glej app.css @media 768px).
    // Na PC ta gumb sploh ni viden, klic je torej tam neškodljiv no-op.
    window.preklopiVecMeni = function(prisiliZapri) {
        let nav = document.getElementById('navPreklopnik'); if(!nav) return;
        if(prisiliZapri) { nav.classList.remove('meni-odprt'); return; }
